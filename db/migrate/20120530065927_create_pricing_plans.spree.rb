# This migration comes from spree (originally 20110406043000)
class CreatePricingPlans < ActiveRecord::Migration
  def self.up
    create_table :spree_pricing_plans do |t|
    ...
    Spree::PricingPlan.create([{:plan_name=>"Basic",:amount=>20,:transaction_fee=>3,:no_of_products=>15,:payment_period=>"Monthly",:is_active=>1},
  ...
  def self.down
    drop_table :spree_pricing_plans
  end
end
