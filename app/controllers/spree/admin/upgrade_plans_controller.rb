class Spree::Admin::UpgradePlansController < Spree::Admin::ResourceController
  #resource_controller
  def index
  ...
  def user_update_plan
    ...
    upgrade=Spree::UpgradePlan.create(:store_owner_id=>user.id,:plan_id=>user.pricing_plan_id)
    upgrade.save
